// =========================================
// SCRIPT DE PRODUTOS FEMININOS
// RUA13 - STREET KACE
// =========================================

console.log('=== PRODUTOS FEMININOS - INICIANDO ===');

document.addEventListener('DOMContentLoaded', function() {
    console.log('DOM carregado - iniciando busca de produtos femininos');
    ...
    async function buscarProdutos() {
        try {
            ...
            const url = 'http://localhost/Rua13/Backend/api/produtos.php?action=get_produtos&categoria=Feminino';
            console.log('URL:', url);
        ...
        container.innerHTML = `
            <div class="col-12">
                <div class="alert alert-info text-center">
                    ...
                    Nenhum produto feminino encontrado no momento.
                </div>
            </div>
        `;
    }
    ...
    console.log('Iniciando busca de produtos femininos...');
    buscarProdutos();
});

console.log('=== PRODUTOS FEMININOS - SCRIPT CARREGADO ===');
